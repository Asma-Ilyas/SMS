...
class StoreClassRequest extends FormRequest
{
    ...
    public function withValidator($validator)
    {
        $validator->after(function ($validator) {
            ...
            if ($stream) {
                // Science stream requires an elective track
                if ($stream->name === 'Science' && empty($this->elective_track_id)) {
                    $validator->errors()->add('elective_track_id', 'Science stream requires an elective track (Biology or Computer Science).');
                }
                
                // Arts stream cannot have an elective track
            ...
            // Ensure elective track belongs to the selected stream
