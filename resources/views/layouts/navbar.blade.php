    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <div class="flex items-center gap-2 text-xs text-gray-500">
                        ...
                        <span class="text-gray-700 font-medium">@yield('page_subtitle', 'Overview')</span>
                    </div>
                </div>
            </div>
            ...
            <div class="flex items-center gap-2 sm:gap-3">
                <!-- Quick Actions -->
                <button class="hidden sm:flex items-center gap-2 px-3 py-2 text-sm font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-100 rounded-lg transition-colors">
