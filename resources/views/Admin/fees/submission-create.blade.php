{{-- resources/views/Admin/fees/submission-create.blade.php --}}

@extends('layouts.app')

@section('title', 'Add Fee Submission')
    ...
    <div class="container mx-auto px-4">
        <div class="mb-6">
            <div class="flex justify-between items-center">
                <div>
                    <h1 class="text-3xl font-bold text-gray-800">➕ Add Fee Submission</h1>
                    <p class="text-gray-500 mt-1">Record a new fee payment from a student</p>
                </div>
        ...
        <div class="bg-white rounded-2xl shadow-xl p-6">
            <form action="{{ route('admin.fee-submissions.store') }}" method="POST">
                @csrf
                ...
                <div class="mt-4 grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="period" class="w-full rounded-lg border-gray-300 focus:ring-2 focus:ring-indigo-500">
                            ...
                            <option value="annually" {{ old('period') == 'annually' ? 'selected' : '' }}>Annually</option>
                            <option value="one_time" {{ old('period') == 'one_time' ? 'selected' : '' }}>One Time</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="mt-4 grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="date" name="submission_date" value="{{ old('submission_date', date('Y-m-d')) }}" 
                ...
                <div class="mt-4">
                    ...
                    <textarea name="remarks" rows="3" class="w-full rounded-lg border-gray-300 focus:ring-2 focus:ring-indigo-500">{{ old('remarks') }}</textarea>
