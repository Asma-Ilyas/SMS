...
@section('content')
<div class="p-6">
    <h1 class="text-2xl font-bold text-gray-900 mb-6">Transport Fee Payments</h1>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-4">
        <form action="{{ route('admin.transport-fee-payments.generate') }}" method="POST" class="flex flex-wrap items-end gap-3">
            @csrf
            <div>
        ...
        <p class="text-xs text-gray-500 mt-2">Creates a pending fee record for every actively-assigned student who doesn't already have one for that month.</p>
    </div>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50" x-data="{ payOpen: false }">
                        <td class="px-6 py-4 text-sm font-medium text-gray-900">{{ $p->studentTransport->student->first_name }} {{ $p->studentTransport->student->last_name }}</td>
                        ...
                        <td class="px-6 py-4 text-right">
                            ...
                            <div x-show="payOpen" x-cloak
                                ...
                                <div @click.away="payOpen = false" class="bg-white rounded-2xl shadow-xl max-w-md w-full p-6 text-left">
                                    ...
                                    <form action="{{ route('admin.transport-fee-payments.pay', $p) }}" method="POST" class="space-y-3">
                                        @csrf
                                        <div>
